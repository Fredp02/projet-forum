        ...
        <?php foreach ($result as $key) :?>
            <div class="blocResultat">
                <div class="blocResultatHeader">
                    <a href="?controller=topics&action=thread&threadID=<?=$key->topicID;?>#<?=$key->messageID;?>"><h2><?=$key->topicTitle;?></h2></a>
                ...
                <div class="blocResultatFooter">
                    ...
                    <div class="dateMessage"><span>le <?= \Controllers\Services\Toolbox::convertDate($key->messageDate);?> </span></div>
                </div>
            </div>
        <?php endforeach;?>
