<div class="reset">
    ...
    <div class="contentReset">
        ...
        <div class="divFormPassword">
            <form method="POST" class="formPassword" action="<?= URL ?>validationResetPassword/<?= $jwt ?>" onsubmit="return validateFormReset()">
                ...
                <div class="divNouveauPassword">
                    ...
                    <input type="password" name="nouveauPassword" id="nouveauPassword" class="nouveauPassword" placeholder="Mot de passe...">
                </div>
                <div class="divConfirmPassword">
                    <label for="confirmPassword">Confirmer le mot de passe :</label>
                    <input type="password" name="confirmPassword" id="confirmPassword" class="confirmPassword" placeholder="Confirmez...">
                </div>
